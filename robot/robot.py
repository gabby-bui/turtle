...
# left leg
trt.up()
trt.goto((-3/8)*side, (-7/8)*side)
#This line has one extra ) next to the word "side" at the end. Hence, I removed it
trt.down()
...
trt.up()
trt.goto((-1/2)*side, -side)
#This line was missing the multiplication (*), hence I added it
trt.down()
